...
function ConditionLogicSelector({
  ...
  return (
    <div className="flex flex-row w-[73px] h-8 bg-giant-blue/10 border border-giant-blue rounded-3xl text-giant-blue text-sm items-center">
      <select
      ...
      <ChevronDown className="text-giant-blue p-1 relative right-2 w-8 h-8" />
    </div>
    // <Select
    //   className="w-[73px] border-giant-blue rounded-3xl h-8 text-giant-blue bg-giant-blue/10 flex items-center justify-center py-0 pl-2"
    //   value={value}
