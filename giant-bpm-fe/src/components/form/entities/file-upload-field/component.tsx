...
const DownloadButton = () => (
  <div className="shrink-0 flex items-center justify-center">
    <FileDownloadIcon className="w-5 h-5 text-giant-blue" />
  </div>
);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-1 text-center">
        ...
        <span className="inline-flex h-[36px] items-center justify-center rounded-[6px] border border-stroke bg-white px-[16px] text-[14px] font-medium text-dark-3 shadow-sm hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-giant-blue disabled:pointer-events-none disabled:opacity-50">
          {buttonText}
        </span>
      </div>
    </label>
        ...
        {status === "uploading" && (
          <>
            <div className="flex items-center justify-between text-[13px] mb-2">
              ...
              <span className="text-giant-blue font-medium">Uploading...</span>
            </div>
            <div className="w-full bg-gray-3 rounded-full h-1.5">
              <div
                className="bg-giant-blue h-1.5 rounded-full transition-all duration-300"
          ...
          <div className="flex flex-col gap-3 mt-1">
            ...
            {hasMoreReviewFiles && (
              <button
                ...
                className="inline-flex items-center justify-center h-[24px] bg-white px-[16px] text-[14px] font-medium text-giant-blue cursor-pointer"
          ...
          <div className="flex flex-col gap-3 mt-1">
            ...
            {hasMoreCommittedFiles && (
              <button
                type="button"
                onClick={handleOpenFilesModal}
                className="inline-flex items-center justify-center h-[36px] rounded-[6px] border border-stroke bg-white px-[16px] text-[14px] font-medium text-primary-text shadow-sm hover:bg-slate-50 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-giant-blue"
