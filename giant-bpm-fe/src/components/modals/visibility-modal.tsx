...
function Entity(props: {
  ...
  return (
    <div
      className={cn(
        "flex flex-col w-full min-w-full hover:inset-ring-2 hover:inset-ring-giant-blue hover:rounded-md flex-1 p-4",
        props.isHidden ? "bg-gray-2" : "bg-white",
        // type === EntityKey.container && "hover:inset-ring-transparent",
        {
          "inset-ring-giant-blue inset-ring-2 rounded-md":
