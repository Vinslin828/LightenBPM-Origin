                      ...
                      <td className="px-6 py-4 text-right min-w-32">
                        {dataset.source_type !== "EXTERNAL_API" ? (
                          <button
                            ...
                            className="inline-flex items-center justify-center rounded-md p-2 text-secondary-text transition-colors hover:bg-gray-100 hover:text-giant-blue cursor-pointer"
