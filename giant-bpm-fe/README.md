...
A React + Vite frontend application for the Giant BPM (Business Process Management) system. Features a form builder, workflow management, and master data management capabilities.
