...
// Email configuration
const SENDER_EMAIL = process.env.SENDER_EMAIL || 'no-reply-bpm@uat.lightencycling.com';
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="color: #6b7280; font-size: 12px; text-align: center; margin-top: 20px;">
    <p>This is an automated notification from Lighten BPM [${stage.toUpperCase()}]</p>
