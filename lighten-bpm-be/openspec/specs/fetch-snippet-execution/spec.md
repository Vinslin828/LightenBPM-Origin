...
The Script Execution service provides a secure environment for running user-defined JavaScript code. It is primarily used for executing external API fetches defined in form components.
