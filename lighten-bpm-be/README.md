...
This repository contains the backend API for the Lighten BPM project, built with the [NestJS](https://nestjs.com/) framework. It uses Prisma as the ORM and provides a local development environment using Docker.
...
1.  Clone the repository:
    ```bash
    git clone https://gitlab.com/bct-taipei/lighten-bpm-be.git
    cd lighten-bpm-be
    ```
