...
# This script retrieves the routing graph for a specific application instance by its serial number.
# It requires the host URL, an auth token, and the application serial number.

# --- Usage ---
# ./dev-utils/get-app-routing.sh <HOST_URL> <AUTH_TOKEN> <SERIAL_NUMBER>
#
# Arguments:
...
#   ./dev-utils/get-app-routing.sh http://localhost:3000 $USER1_TOKEN $SERIAL_NUMBER
# ---
...
API_ENDPOINT="${HOST_URL}/bpm/applications/${SERIAL_NUMBER}/routing"

# 4. Execute the curl command
echo "Fetching routing graph from: ${API_ENDPOINT}"
