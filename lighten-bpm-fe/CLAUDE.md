# Lighten BPM Frontend - Project Instructions

@docs/ADD_NEW_ENTITY.md

## Project Overview
This is a React + Vite frontend application for the Lighten BPM (Business Process Management) system. It features a form builder, workflow management, and master data management capabilities.
