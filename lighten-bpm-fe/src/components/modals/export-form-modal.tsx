...
import { useExportForm } from "@/hooks/useForm";
...
export default function ExportFormModal({ formId, formName, ...props }: Props) {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      // Cap simulated progress at 90% until API responds
    ...
    exportForm(formId)
      .then((response) => {
        ...
        a.href = url;
        a.download = `${formName.replace(/\s+/g, "_")}.json`;
  ...
  return (
    <Modal {...props}>
      <div className="p-7.5 flex flex-col gap-7.5 items-center">
        <span className="text-dark text-2xl font-semibold">Export</span>
          ...
          <div className="w-full border border-stroke rounded-lg px-5 py-4 flex gap-5 items-center">
            ...
            <div className="flex-1 flex flex-col gap-1 min-w-0">
              ...
              <div className="flex items-center justify-between text-sm font-medium">
                ...
                <span
                  className={
                    state === "error" ? "text-red-500" : "text-lighten-blue"
                  }
                >
                  {statusText}
                </span>
              ...
              <div className="h-2 w-full bg-gray-200 rounded-full">
                <div
                  className={`h-2 rounded-full transition-all duration-100 ${
                    state === "error" ? "bg-red-500" : "bg-lighten-blue"
                  }`}
