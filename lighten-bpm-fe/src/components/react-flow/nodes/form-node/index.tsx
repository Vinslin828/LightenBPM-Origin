        ...
        <div className="w-[280px] min-h-[84px] bg-white rounded-md overflow-clip flex-row flex">
          <div className="flex flex-col gap-2.5 px-4 py-3 justify-between">
            ...
            {data.form?.id && data.form?.name ? (
              <div className="text-sm font-medium text-lighten-blue leading-5 break-words cursor-pointer">
                <span
                  onClick={() => {
              ...
              <div className="bg-blue-light-5 text-lighten-blue rounded-xs text-xs font-medium h-6 px-2 flex items-center justify-center">
                Click to configure
              </div>
            )}
          </div>
