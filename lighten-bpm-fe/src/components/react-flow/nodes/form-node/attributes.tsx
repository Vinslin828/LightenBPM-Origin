              ...
              content: (
                <div className="flex w-full flex-col gap-4">
                  ...
                  {applicantSource === "selection" && (
                    <div className="flex gap-2 items-start px-3 py-2.5 rounded-md border border-lighten-blue/20 bg-lighten-blue/10">
                      <Info className="w-5 h-5 text-lighten-blue shrink-0 mt-0.5" />
