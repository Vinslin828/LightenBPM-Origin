...
export default function CodeToggle({
  ...
  const baseButtonClasses =
    "flex h-7 w-7 items-center justify-center rounded-[4px] p-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lighten-blue focus-visible:ring-offset-2";
