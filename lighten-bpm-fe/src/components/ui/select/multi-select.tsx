          ...
          {selectedLabels.length > 0 ? (
            <div className="flex flex-row gap-1">
              {selectedLabels.map((label, idx) => (
                <div
                  key={`${label}-${idx}`}
                  className="bg-lighten-blue/10 flex flex-row gap-2.5 pl-[15px] pr-2.5 h-9 items-center rounded-sm"
                >
                  {label}
                  <XIcon
              ...
              >
                <span
                  className={cn(
                    ...
                    isSelected && "border-lighten-blue bg-lighten-blue text-white",
                  )}
                >
