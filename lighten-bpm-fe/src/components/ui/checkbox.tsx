      ...
      <div className={cn("inline-flex items-center", className)}>
        ...
        >
          <input
            ...
            className={cn(
              "peer h-5 w-5 appearance-none rounded border border-stroke transition-all checked:border-lighten-blue checked:bg-lighten-blue disabled:bg-gray-2 bg-white",
              isDisabled && isChecked && "disabled:border-lighten-blue disabled:bg-lighten-blue",
              readonly ? "cursor-default" : "cursor-pointer",
            )}
            {...props}
