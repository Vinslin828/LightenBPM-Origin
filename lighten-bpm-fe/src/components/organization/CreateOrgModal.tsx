        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              disabled={isSubmitting}
              className="flex h-12 w-full rounded-[6px] border border-stroke bg-white px-5 py-3 text-base font-normal text-dark focus:border-[1.5px] focus:border-lighten-blue focus:outline-none disabled:bg-gray-2 disabled:text-primary-text disabled:border-gray-2"
            >
