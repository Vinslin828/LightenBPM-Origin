...
import { multipleSelectionAttribute } from './definition'

export const MultipleSelectionAttribute = createAttributeComponent(
  multipleSelectionAttribute,
  function MultipleSelectionAttribute(props) {
    return (
      <div>
