...
#### [MODIFY] [schema.prisma](file:///Users/robertchen/Projects/giant-bpm-be/prisma/schema.prisma)
...
#### [MODIFY] [attachment.repository.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/repositories/attachment.repository.ts)
...
#### [DELETE] [pending-upload.repository.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/repositories/pending-upload.repository.ts)

#### [MODIFY] [attachment.service.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/attachment.service.ts)
...
#### [MODIFY] [attachment.module.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/attachment.module.ts)

- Remove `PendingUploadRepository`

#### [MODIFY] [attachment.controller.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/attachment.controller.ts)

- Pass `user: AuthUser` to service for `user.code`

#### [NEW] [draft-attachment.controller.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/draft-attachment.controller.ts)

- Init, presign, confirm, list, delete (routes 7–11)

#### [MODIFY] [attachment-admin.controller.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/attachment-admin.controller.ts)
...
#### [MODIFY] [confirm-upload.dto.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/dto/confirm-upload.dto.ts)

- Keep only `s3_key` + `remark` (metadata stored from presign step)

#### [NEW] [draft-init-response.dto.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/dto/draft-init-response.dto.ts)

- Field: `draft_id: string`

#### [MODIFY] [pending-upload-response.dto.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/attachment/dto/pending-upload-response.dto.ts)
...
#### [MODIFY] [create-application-instance.dto.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/instance/dto/create-application-instance.dto.ts)

- Add optional `draft_id?: string`

#### [MODIFY] [application.controller.ts](file:///Users/robertchen/Projects/giant-bpm-be/src/instance/application.controller.ts)
