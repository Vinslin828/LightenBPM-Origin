...
2. Script will accept 3 arguments:
   - `HOST_URL` (e.g. `https://api-dev.mp-dev.ds.giantcycling.com`)
...
- Upon completion, I will run the script (or the user can run it) against `https://api-dev.mp-dev.ds.giantcycling.com` using a valid user token and serial number.
