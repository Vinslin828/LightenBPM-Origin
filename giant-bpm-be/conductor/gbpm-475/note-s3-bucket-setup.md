...
- **Why**: I looked at how the ECS task role was *already* configured in [/infrastructure/application.yaml](cci:7://file:///Users/robertchen/Projects/giant-bpm-be/infrastructure/application.yaml:0:0-0:0). It currently uses inline policies (e.g., `SQSPublishPolicy` and `SecretsManagerReadPolicy`). I just followed the existing pattern in your repo, whereas the other project decided to separate it into a Managed Policy.
